      ...
      <div class="row">
         <div class="col-lg-10 offset-lg-1 col-md-12 col-12">
                     ...
                     <div class="row">
                        ...
                        <div class="col-lg-2 col-md-2 col-12 p-0" style="margin: 15px 20px 15px 0px; padding: 10px;">
                           <div class="search-input">
                              ...
                              <input type="text" name="startdate" id="startDate" value="20170101" placeholder="시작날짜">
                           </div>
                        </div>
                        <div class="col-lg-2 col-md-2 col-12 p-0" style="margin: 15px 20px 15px 0px; padding: 10px;">
                           <div class="search-input">
                              <label for="category"><i class="lni lni-calendar"></i></label> 
                              <input type="text"name="enddate" id="endDate" value="20170113" placeholder="종료날짜">
                           </div>
                        </div>
            ...
            <!-- End Search Form -->
				<!-- Start Hero Text -->
				<div class="search-form wow fadeInUp" data-wow-delay=".7s">
                  <h5 class="wow fadeInUp" data-wow-delay=".3s" style="color:#ddd; text-align :left;"> <big>검색 옵션이 궁금해요!</big> </h5><br>
		...
		<div class="single-head">
				...
				<div class="col-lg-12 col-md-6 col-12">
					...
					<div class="content">
                                <div class="top-content">
                                    ...
                                    <p>선택한 종목, 기간의 주가 그래프입니다. 그래프 위로 마우스를 대면 날짜별 주가를 확인할 수 있습니다. </p>
                                </div>
                            </div>
						<div class="chart">
							<!-- 이미지 칸에 차트를 넣을 경우 위치. -->
                        ...
                        <div class="single-grid wow fadeInUp" data-wow-delay=".4s">
                         <div class="content">
                                <div class="top-content">
                                    ...
                                    <p>뉴스 긍부정과 주가 등락률 간의 그래프를 확인해보세요. 날짜별로 검은색은 주가, 파란색은 뉴스 긍부정 지수를 나타냅니다.</p>
                                </div>
                            </div>
                            <div class="chart">
			...
			<div class="col-lg-4 col-md-6 col-12">
                        ...
                        <div class="content">
                                <div class="top-content">
                                    <h3 class="title">
                                        <a href="item-details.html">뉴스 헤드라인 긍정 단어 분포도</a>
                                    </h3>
                                    <p>뉴스 헤드라인의 단어 분포 분석 결과입니다. 파란색은 긍정, 빨간색은 부정 단어를 나타냅니다. 긍정 단어만 보고 싶다면 부정을, 부정 단어만 보고 싶다면 긍정을 선택하세요. </p>
                                </div>
                            </div>
			...
			<div class="col-lg-4 col-md-6 col-12">
                        ...
                        <div class="content">
                                <div class="top-content">
                                    <h3 class="title">
                                        <a href="item-details.html">뉴스 헤드라인 모든 단어 분포도</a>
                                    </h3>
                                    <p>뉴스 헤드라인의 단어 분포 분석 결과입니다. 파란색은 긍정, 빨간색은 부정 단어를 나타냅니다. 긍정 단어만 보고 싶다면 부정을, 부정 단어만 보고 싶다면 긍정을 선택하세요. </p>
                                </div>
                            </div>
			...
			<div class="col-lg-4 col-md-6 col-12">
                        ...
                        <div class="content">
                                <div class="top-content">
                                    <h3 class="title">
                                        <a href="item-details.html">뉴스 헤드라인 부정 단어 분포도</a>
                                    </h3>
                                    <p>뉴스 헤드라인의 단어 분포 분석 결과입니다. 파란색은 긍정, 빨간색은 부정 단어를 나타냅니다. 긍정 단어만 보고 싶다면 부정을, 부정 단어만 보고 싶다면 긍정을 선택하세요. </p>
                                </div>
                            </div>
