...
======================= */
 /* function Create_am_WordCloud(all_text){
...
function CreateHeatMap(heat_data){
   ...
   Highcharts.chart('heatmap_chart', {
    ...
    tooltip: {
        formatter: function () {
            return ' x: ' + getPointCategoryName(this.point, 'x') + ', y: ' + getPointCategoryName(this.point, 'y') +
            ' <br> 상관계수: '+ this.point.value;
        }
    },
                ...
                $.ajax({
                    ...
                    success : function(get_data) {
                     // console.log(get_data)
                      ...
                      const wc_text = JSON.parse(get_data);
                  	  const all_text = wc_text.all_keyword;
                      //Create_am_WordCloud(all_text);
